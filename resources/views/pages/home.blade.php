...
<header class="text-center">
    ...
    <a href="#" class="btn btn-get-started px-4 mt-3">Get started <i class="lni lni-arrow-right"></i></a>
</header>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-lg-3">
                <div class="popular-destination-card text-center d-flex flex-column my-auto" style="background-image: url('frontend/images/header-bg.jpg')">
                    <div class="region-title">Bandung</div>
                    <div class="destination-title">Lembang</div>
                    <div class="popular-destination-card-button mt-auto">
                        <a href="" class="btn btn-details px-4">More details</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-lg-3">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <lottie-player src="https://assets7.lottiefiles.com/temp/lf20_j1duSs.json" background="transparent" speed="1" autoplay loop></lottie-player>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8 mt-4 mx-auto text-center">
                ...
                <a class="btn btn-get-started px-4" href="">Get Started <i class="lni lni-arrow-right"></i></a>
            </div>
        </div>
    </div>
</section>
